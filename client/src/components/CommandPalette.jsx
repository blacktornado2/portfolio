...
export default function CommandPalette({ isOpen, onClose }) {
  ...
  const COMMANDS = useMemo(() => [
    ...
    },
    {
      group: "Social",
      items: [
        { id: "github",   label: "Open GitHub",   icon: "github",   hint: "↗", action: () => { window.open("https://github.com/ankitBhardwaj21", "_blank"); onClose(); } },
        { id: "linkedin", label: "Open LinkedIn", icon: "linkedin", hint: "↗", action: () => { window.open("https://linkedin.com/in/ankit-bhardwaj", "_blank"); onClose(); } },
      ],
    },
    {
      group: "Actions",
                        ...
                        {group.items.map((item) => {
                          ...
                          return (
                            <button
                              ...
                              className={`flex items-center gap-3 w-full px-4 py-2.5 text-left border-0 cursor-pointer transition-colors duration-75 ${
                                isActive
